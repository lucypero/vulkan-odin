...
when ODIN_OS == "windows" {
	...
	ProcDestroyAccelerationStructureNV                                  :: #type proc"stdcall"(device: Device, accelerationStructure: AccelerationStructureKHR, pAllocator: ^AllocationCallbacks);
	...
	ProcBindAccelerationStructureMemoryKHR                              :: #type proc"stdcall"(device: Device, bindInfoCount: u32, pBindInfos: ^BindAccelerationStructureMemoryInfoKHR) -> Result;
	ProcBindAccelerationStructureMemoryNV                               :: #type proc"stdcall"(device: Device, bindInfoCount: u32, pBindInfos: ^BindAccelerationStructureMemoryInfoKHR) -> Result;
	ProcCmdBuildAccelerationStructureNV                                 :: #type proc"stdcall"(commandBuffer: CommandBuffer, pInfo: ^AccelerationStructureInfoNV, instanceData: Buffer, instanceOffset: DeviceSize, update: b32, dst: AccelerationStructureKHR, src: AccelerationStructureKHR, scratch: Buffer, scratchOffset: DeviceSize);
	ProcCmdCopyAccelerationStructureNV                                  :: #type proc"stdcall"(commandBuffer: CommandBuffer, dst: AccelerationStructureKHR, src: AccelerationStructureKHR, mode: CopyAccelerationStructureModeKHR);
	...
	ProcGetAccelerationStructureHandleNV                                :: #type proc"stdcall"(device: Device, accelerationStructure: AccelerationStructureKHR, dataSize: int, pData: rawptr) -> Result;
	...
	ProcCmdWriteAccelerationStructuresPropertiesNV                      :: #type proc"stdcall"(commandBuffer: CommandBuffer, accelerationStructureCount: u32, pAccelerationStructures: ^AccelerationStructureKHR, queryType: QueryType, queryPool: QueryPool, firstQuery: u32);
...
BindAccelerationStructureMemoryKHR:              ProcBindAccelerationStructureMemoryKHR;
...
load_proc_addresses_with_instance :: proc(instance: ^Instance) {
	...
	BindAccelerationStructureMemoryKHR = auto_cast GetInstanceProcAddr(instance^, "vkBindAccelerationStructureMemoryKHR");
